...
[
     ...
     ["","chinx/38",""],
     ["¿Quieres pasar un mal rato?","chinx/39","control:speed=70,paget=500,reproAuto=true,repro=true,voice=/media/pj/chinx/sansV.wav;function:musics=megalovania+play+false+0.2"],
     ["mhhj!","chinx/40","control:voice=/media/audio/voiceV.wav;function:musics=megalovania+stop+false+0.3"],
     ["¿Vistes pasar aquel raton?","chinx/16","control:voice=/media/pj/chinx/voiceV.wav"],
     // LA RAZÓN DE NO TENER VOZ
     ["Podria pedirle a amigos que me presten su voz","chinx/2","chinx:voice=/Chinxtest/media/audio/voiceV.wav;control:speed=60,paget=950,reproAuto=false,repro=false"],
